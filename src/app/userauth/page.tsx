      ...
      >
        ...
        <div className="flex-1 flex flex-col justify-center py-6 lg:py-8 max-w-md mx-auto w-full">
          ...
          <motion.div variants={itemVariants} className="mb-5">
            <button className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-lg border border-gray-300 font-medium text-sm text-gray-700 hover:bg-gray-50 transition-colors">
