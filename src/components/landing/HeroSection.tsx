        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-0">
          ...
          >
            ...
            <div>
              ...
              <motion.div variants={itemVariants} className="mb-8">
                ...
                <p className="text-xs  mt-1">
                  High-quality 4k AI generated Images{" "}
                </p>
              </motion.div>
              ...
              >
                ...
                <span className="text-xs font-medium ">
                  + Become one of 4000+ happy users
                </span>
              </motion.div>
              ...
              >
                Log in to start your next great recording session, capture what
                matters, save stories, and turn real talk into stunning content.
              </motion.p>
            </div>
            ...
            <motion.div variants={itemVariants} className="flex gap-4">
              <Link
                href="/gallery"
                className="flex items-center gap-2 px-6 py-3 rounded-lg border border-border font-medium  transition-colors"
              >
                <ArrowLeft size={18} />
                Gallery
              </Link>
